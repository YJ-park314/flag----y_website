            ...
            <table class="cstm-table data-table no-head">
                ...
                <tbody>
                    ...
                    <tr ondblclick="popData();">
                        ...
                        <td class="wr-no">485</td>
                        <td class="subject">사인요청드립니다</td>
                        <td class="user-name">홍길동</td>
                        <td class="user-id">test1234</td>
                        <td class="content">내용 : <span>안녕하세요 아까 연락드렸던 사람입니다. 시안 보내드렸는데 확인해주세요.</span></td>
                        <td class="wr-date">2025-02-06</td>
                        <td class="hit">3</td>
                        <td class="answer-cnt">0</td>
                        <td class="hp">--</td>
                        <td class="del">on</td>
                        <td class="read">N</td>
                    </tr>
