            ...
            <table class="cstm-table">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col"><a href="#">옵션</a></th>
                        <th scope="col"><a href="#">가격</a></th>
                        <th scope="col"><a href="#">주문상태</a></th>
                        <th scope="col"><a href="#">신청방법</a></th>
                        <th scope="col"><a href="#">주문자</a></th>
                        <th scope="col"><a href="#">ID</a></th>
                        <th scope="col"><a href="#">핸드폰</a></th>
                        <th scope="col"><a href="#">이메일</a></th>
                        <th scope="col"><a href="#">우편</a></th>
                        <th scope="col"><a href="#">신청일</a></th>
                        <th scope="col"><a href="#">입금은행</a></th>
                        <th scope="col"><a href="#">입금자</a></th>
                        <th scope="col"><a href="#">예정일</a></th>
                        <th scope="col"><a href="#">결제방법</a></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td class="prdt-name"><input type="text" name="prdtName"></td>
                        <td class="option"><input type="text" name="option"></td>
                        <td class="price"></td>
                        <td class="order-status">
                            <select name="orderStatus" id="orderStatus">
                                ...
                                <option value="시안작업">시안작업</option>
                                <option value="시안확인">시안확인</option>
                                <option value="시안확정">시안확정</option>
                        ...
                        <td class="regi-date">
                            <input type="date" name="regiDate1"> -
                            <input type="date" name="regiDate2">
                        </td>
                        <td class="bank"><input type="text" name="bank"></td>
                        <td class="depositor"><input type="text" name="depositor"></td>
                        <td class="complete-schedule"><input type="text" name="completeSchedule"></td>
                        <td class="pay-to">
            ...
            <table class="cstm-table data-table no-head">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="idx">2502100001</td>
                        <td class="prdt-name">금수술, 마크(FL30)</td>
                        <td class="option">보관설치서비스원함</td>
                        <td class="price">240,000</td>
                        <td class="order-status">A</td>
                        <td class="apply-to">컴퓨터</td>
                        <td class="user-name">송언석</td>
                        <td class="user-id">esong63</td>
                        <td class="hp">010-1234-1234</td>
                        <td class="mail">aaa@naver.com</td>
                        <td class="zip"></td>
                        <td class="regi-date">2025-02-10</td>
                        <td class="bank">우리은행 1002-255-000000</td>
                        <td class="depositor">송언석</td>
                        <td class="complete-schedule">2025-02-10</td>
                        <td class="pay-to">무통장</td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
