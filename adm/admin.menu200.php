...
$menu['menu200'] = array(
    ...
    array('200910', '고객(단체)관리', G5_ADMIN_URL . '/member_manage.php'),
    array('200930', '고객(단체)깃발관리', G5_ADMIN_URL . '/flag_manage.php'), 
    array('200940', '미회수 깃발조회', G5_ADMIN_URL . '/noreturn_manage.php'),  
    array('200920', '전자세금(기본정보)', G5_ADMIN_URL . '/online_tax_info.php'),  
    array('200950', '전자세금(도우미)', G5_ADMIN_URL . '/online_tax_help.php'),   
    array('200960', '전자세금(발행)관리', G5_ADMIN_URL . '/online_tax_manage.php'),   
);
