    ...
    <div id="hd_top">
        ...
        <div id="tnb">
            <ul>
                ...
                <li><a href="<?php echo G5_ADMIN_URL ?>/order_list.php" class="tnb_service" target="_blank">주문상황(창고)</a></li>
                <li><a href="<?php echo G5_ADMIN_URL ?>/collect_list.php?date=<?php echo date('Y-m-d'); ?>" class="tnb_service" target="_blank">회수상황(창고)</a></li>
        ...
        <div id="bookmark"> 
            <ul>
                <li><a href="<?php echo G5_ADMIN_URL ?>/shop_admin/orderlist.php" class="button gray">깃발배송주문</a></li>
                <li><a href="<?php echo G5_ADMIN_URL ?>/shop_admin/payment_manage.php" class="button blue">고객결제(입금)관리</a></li>
                <li><a href="<?php echo G5_ADMIN_URL ?>/shop_admin/set_place_manage.php" class="button green">설치장소관리</a></li>
                <li><a href="<?php echo G5_ADMIN_URL ?>/member_manage.php" class="button blue">고객(단체)관리</a></li>
                <li><a href="<?php echo G5_ADMIN_URL ?>/design_apply.php" class="button green">시안요청(게시판)</a></li>
                <li><a href="<?php echo G5_ADMIN_URL ?>/" class="button gray">제작주문(고객요청)</a></li>
                <li><a href="<?php echo G5_ADMIN_URL ?>/shop_admin/misu_manage.php" class="button red">미수금관리</a></li>
            </ul>
        </div>
    </div>
