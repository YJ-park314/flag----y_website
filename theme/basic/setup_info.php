...
<article id="setupInfo" class="wrap">
    <h2><?php echo $vis_name; ?></h2>
    <!-- 배송 공통 탭메뉴 -->
    <?php include_once(G5_THEME_PATH.'/component/setup_tab_menu.php'); ?>

    <!-- 배송정보 -->
    <?php include_once(G5_THEME_PATH.'/component/delivery_info.php'); ?>

    <!-- <section class="service">
        <div class="tit-area">
            <h3>깃발배송 서비스 특징</h3>
            <p>27년 전통 전국 7800단체, 국내 유일의 깃발 관리 및 보관 시스템</p>
        </div>
        <ul class="info-shape">
    ...
    <section class="price center">
        <div class="tit-area"><h3>배달가격표</h3></div>
    ...
    <section>
        <div class="tit-area"><h3>입금방법 안내</h3></div>
        <ul class="info-shape">
