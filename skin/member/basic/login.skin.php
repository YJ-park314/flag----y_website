...
<!-- 로그인 시작 { -->
<div id="mb_login" class="mbskin wrap">
    <div class="mbskin_box left">
        <h1><?php echo $g5['title'] ?></h1>
        <!-- <div class="mb_log_cate dpnone">
        ...
        <fieldset id="login_fs">
            <legend>회원로그인</legend>
            <label for="login_id" class="tit">아이디<strong class="sound_only"> 필수</strong></label>
            <input type="text" name="mb_id" id="login_id" required class="frm_input" size="20" maxLength="20" placeholder="아이디">
            <label for="login_pw" class="tit">비밀번호<strong class="sound_only"> 필수</strong></label>
            ...
            <div id="login_info">
                ...
                <div class="login_if_lpl">
                    ...
                    <a href="<?php echo G5_BBS_URL ?>/id_lost.php">아이디 / 비밀번호 찾기</a>  
                </div>
            </div>
        </fieldset> 
        </form>
    ...
    <div class="right">
        <dl>
            <dt>대한민국 업계 NO1</dt>
            <dd>정성을 담아 맞춤 제작하는 깃발 전문 업체<br>품질과 신뢰로 고객의 소중한 순간을 함께합니다.</dd>
        </dl>
    </div>
