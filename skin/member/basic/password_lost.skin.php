...
<article id="find_info" class="new_win<?php if($config['cf_cert_use'] != 0 && $config['cf_cert_find'] != 0) { ?> cert<?php } ?> wrap3">
    <h2 class="bo_tit">비밀번호찾기<span class="sound_only"> 본문영역</span></h2>
    <p class="bo-summary">
        회원가입 시 등록하신 이메일 주소를 <br class="mo">입력해 주세요.<br>
        해당 이메일로 아이디와 <br class="mo">비밀번호 정보를 보내드립니다.
    </p>
    ...
    <section class="new_win_con">
        <form name="fpasswordlost" action="<?php echo $action_url ?>" onsubmit="return fpasswordlost_submit(this);" method="post" autocomplete="off">
            ...
            <div class="win_btn">
                <button type="submit" class="btn_submit btn-point">비밀번호 찾기</button>
            </div>
        </form>
        <div id="login_info">
            <div class="login_if_lpl">
                <a href="https://bangtal3063.mycafe24.com/bbs/register.php">회원가입</a>
                <a href="https://bangtal3063.mycafe24.com/bbs/id_lost.php">아이디 찾기</a>  
            </div>
        </div>
    </section>
