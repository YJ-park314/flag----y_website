...
<section id="bo_w">
    ...
    <div class="bo_w_tit write_div">
        <label for="wr_subject" class="con-label">제목<strong class="sound_only">필수</strong></label>
        
        <div id="autosave_wrapper" class="write_div">
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input" size="50" maxlength="255" placeholder="제목">
    ...
    <div class="write_div">
        <label for="wr_content" class="con-label">내용<strong class="sound_only">필수</strong></label>
    ...
    <div class="btn_confirm write_div">
        <a href="<?php echo get_pretty_url($bo_table); ?>" class="btn-reset">취소</a>
        <button type="submit" id="btn_submit" accesskey="s" class="btn-point">작성하기</button>
    </div>
    </form>
