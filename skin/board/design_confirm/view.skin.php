...
<!-- 게시물 읽기 시작 { -->
<article id="bo_v" class="basic-sub">
    ...
    <div id="bo_v_top">
        <?php ob_start(); ?>
        <ul>
            <?php if ($reply_href && !$view['icon_reply']) { ?><li><a href="<?php echo $reply_href ?>" class="btn-ud">답변</a></li><?php } ?>
            <?php if ($update_href && $write['mb_id'] == $member['mb_id']) { ?><li><a href="<?php echo $update_href ?>" class="btn-ud">수정</a></li><?php } ?>
    ...
    <header>
        <h2 id="bo_v_title">
            ...
            ?></span>
            <span class="bo-date"><?php echo date('y.m.d', strtotime($view['datetime'])) ?></span>
        </h2>
    </header>
    ...
    <a href="<?php echo $list_href ?>" class="list-btn btn-point">목록으로</a>
