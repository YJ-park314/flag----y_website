...
<section id="sit_info" class="wrap">
	<div id="sit_tab">
	    <ul class="tab_tit">
	        <li><button type="button" id="btn_sit_inf" rel="#sit_inf" onclick="location.href='#sit_inf'" class="selected">제품특징</button></li>
	        ...
	        <li><button type="button" id="btn_sit_dvex" rel="#sit_dex" onclick="location.href='#sit_dex'">배송비</button></li>
	        <li><button type="button" id="btn_sit_deposit" rel="#sit_deposit" onclick="location.href='#sit_deposit'">입금방법</button></li>
	        <li><button type="button" id="btn_sit_color" rel="#sit_color" onclick="location.href='#sit_color'">수술색상</button></li>
	    </ul>
	    <ul class="tab_con del-info">
			<!-- 배송정보 -->
			<?php
				$use_page = '상품디테일';
				include_once(G5_THEME_PATH.'/component/delivery_info.php');
			?>

			<li id="sit_color">
				<div class="tit-area"><p>수술색상</p></div>
				<div class="img-area">
					<img src="/theme/basic/img/shop_detail1.jpg" alt="수술색상이미지">
				</div>
				<p>삼발이 세트</p>
			</li>
			...
			<?php
				/*
				<li id="sit_inf">
					<h2 class="contents_tit"><span>제품 특징</span></h2>
					...
					<?php
							...
							if($is_admin) {
								echo '<p>제품 특징 고시 정보가 올바르게 저장되지 않았습니다.<br>config.php 파일의 G5_ESCAPE_FUNCTION 설정을 addslashes 로<br>변경하신 후 관리자 &gt; 상품정보 수정에서 제품 특징를 다시 저장해주세요. </p>';
							}
						}
					} //if
					?>
