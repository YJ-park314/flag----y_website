...
<div id="sit_ov_from">
	...
	<div id="sit_ov_wrap" class="wrap"> 
	    ...
	    <div id="sit_pvi">
	        ...
	        if($total_count > 0) {
	            echo '<ul id="sit_pvi_thumb" class="dpnone">';
	    ...
	    <section id="sit_ov" class="2017_renewal_itemform">
	            ...
	            <table class="sit_ov_tbl">
					...
					<tbody>
						...
						<!-- <tr>
							<th scope="row">수량</th>
							<td>
								<a href="#" class="cstm-qty-minus">-</a>
								<span>1</span>
								<a href="#" class="cstm-qty-plus">+</a>
							</td>
						</tr>
						<tr>
							<th scope="row">보관설치</th>
							<td>
								<span>
									<input type="radio" name="cstmsOpt" id="cstmsOpt1" value="보관설치서비스원함">
									<label for="cstmsOpt1">보관설치서비스원함</label>
								</span>
								<span>
									<input type="radio" name="cstmsOpt" id="cstmsOpt2" value="필요없음">
									<label for="cstmsOpt2">필요없음</label>
								</span>
							</td>
						</tr>
						<tr>
							<th scope="row">부속품세트</th>
							<td>
								<input type="checkbox" id="cstmsOpt3" value="부속품세트">
								<label for="cstmsOpt3">가방+깃대+삼각대+가로대 (추가금액 +6만원)</label>
							</td>
						</tr> -->
	        ...
	        <div id="sit_ov_btn">
	            ...
	            <button type="submit" onclick="document.pressed=this.value;" value="제작 주문하기" class="sit_btn_buy btn-point">제작 주문하기</button>
	            <?php } ?>
...
<script>
	...
	$(document).load(function () {
		// $('select.it_option').val('보관설치서비스원함').trigger('change');
		// $('select.it_option').trigger('select_it_option_change', '보관설치서비스원함');
	});

	// window.addEventListener('load', () => {
	// 	const reqireOpt = document.querySelector('#it_option_1');
	// 	const addOpt = document.querySelector('#it_supply_1');

	// 	for (let i=0; i<reqireOpt.options.length; i++) {
	// 		const thisOpVal = reqireOpt.options[i].value.split(',');

	// 		if(thisOpVal[0] == '보관설치서비스원함') {
	// 			$(reqireOpt.options[i]).prop("selected", true);

	// 			setTimeout(() => {
	// 				$(reqireOpt).trigger('change', { add_exec: true });
	// 			}, 100);
