...
<!-- 쇼핑몰 카테고리 시작 { -->
<nav id="gnbShop" class="wrap">
    <h2 class="sound_only">쇼핑몰 카테고리</h2>
    <ul id="gnb_1dul" class="common-tab">
        <?php
        // 1단계 분류 판매 가능한 것만
        ...
        ?>
        <li>
            <a href="<?php echo $row['url']; ?>#shopBnr" class="gnb_1da"><?php echo $row['ca_name']; ?><?php if ($count) echo '<i class="fa fa-angle-right" aria-hidden="true"></i>'; ?></a>
            <?php
            $j=0;
